        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header">
              <h4>Categories</h4>
              <a href="{{ route('admin.blog-category.create') }}" class="btn btn-success" >create</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $category->name }}</td>
                        <td>{{ $category->slug }}</td>
                        <td><a href="{{ route('admin.blog-category.edit',$category->id) }}" class="btn btn-info">edit</a></td>
                        <td>
