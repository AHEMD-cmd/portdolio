			...
			<div class="card-body">
				<form action="{{ route('admin.portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row mb-4">
					  ...
					  <div class="col-sm-12 col-md-7">
						<textarea type="text" class="form-control" name="sub_title">{{ old('sub_title', $portfolio->sub_title) }}</textarea>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="url" class="form-control" value="{{ old('url', $portfolio->url) }}">
...
<script>
	$(document).ready(function(){
        $('#image-preview').css({
            'background-image':'url("{{ asset('portfolio_imgs/'.$portfolio->img) }}")',
