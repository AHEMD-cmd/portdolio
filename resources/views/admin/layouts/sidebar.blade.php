	  ...
	  <aside id="sidebar-wrapper">
		...
		<ul class="sidebar-menu">
		  ...
		  <li class="menu-header">Sections</li>
		   ...
		   <li class="dropdown">
			<a href="{{ route('admin.service.index') }}"><i class="fas fa-columns"></i> <span>Services </span></a>
		  </li>

		   <li class="dropdown">
			<a href="{{ route('admin.about.index') }}"><i class="fas fa-columns"></i> <span>About </span></a>
		  </li>

          <li class="dropdown">
			<a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>portfolio</span></a>
			<ul class="dropdown-menu">
			  <li><a class="nav-link" href="{{ route('admin.category.index') }}">Category Section</a></li>
			  <li><a class="nav-link" href="{{ route('admin.portfolio.index') }}">Portfolio Section</a></li>
			</ul>
		  </li>
          <li class="dropdown">
			<a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Blog</span></a>
			<ul class="dropdown-menu">
			  <li><a class="nav-link" href="{{ route('admin.blog-category.index') }}">Category Section</a></li>
			  <li><a class="nav-link" href="{{ route('admin.blog.index') }}">blogs Section</a></li>
			</ul>
		  </li>
{{--
		  <li class="dropdown">
        ...
        <li>
            <a class="nav-link" href="credits.html"><i class="fas fa-pencil-ruler">
                </i> <span>Credits</span></a>
